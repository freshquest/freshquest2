...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vendor.vendor_type'
        db.alter_column(u'slotting_vendor', 'vendor_type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Vendor.vendor_type'
        db.alter_column(u'slotting_vendor', 'vendor_type', self.gf('django.db.models.fields.CharField')(max_length=8))
